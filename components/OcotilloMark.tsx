export function OcotilloMark({ className = "h-10 w-6" }: { className?: string }) {
  return (
    ...
    >
      ...
      <path d="M7 10 l-3 -4" stroke="#c94a2c" strokeWidth="1.3" strokeLinecap="round" />
      <path d="M7 8 l3 -4" stroke="#c94a2c" strokeWidth="1.3" strokeLinecap="round" />
      <path d="M18 7 l-3 -5" stroke="#d14b2a" strokeWidth="1.4" strokeLinecap="round" />
      <path d="M18 6 l4 -5" stroke="#d14b2a" strokeWidth="1.4" strokeLinecap="round" />
      <path d="M27 11 l-3 -4" stroke="#c94a2c" strokeWidth="1.3" strokeLinecap="round" />
      ...
      <circle cx="6" cy="5" r="1.2" fill="#c94a2c" />
      <circle cx="18" cy="2" r="1.4" fill="#c94a2c" />
